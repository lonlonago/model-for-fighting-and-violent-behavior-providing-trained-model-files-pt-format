# Model for fighting and violent behavior providing trained model files (pt format) and process files

# Body

Model for fighting violence, providing trained model files (pt format), process files, and validation images
Offers corresponding training dataset of 9000 images suitable for learning research and graduation projects
